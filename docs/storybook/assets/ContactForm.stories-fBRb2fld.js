import{f as se,w as m,u as t,a as ce,e as i}from"./index-D9qU3fh3.js";import{j as p}from"./jsx-runtime-C5f8Jhlx.js";import{r as j}from"./iframe-CvuRUNFj.js";import{s as le}from"./ContactForm.module-BIBRmRo0.js";import{F as g}from"./FormField-1AxKU5Kx.js";import{F as ie}from"./FormButton-Bg5UfKL5.js";import"./preload-helper-Dp1pzeXC.js";const oe=({onSubmit:s})=>{const[e,a]=j.useState({name:"",email:"",subject:"",message:""}),[n,c]=j.useState({}),[o,l]=j.useState(!1),P=()=>{const r={};return e.name.trim()||(r.name="お名前は必須です"),e.email.trim()?/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e.email)||(r.email="有効なメールアドレスを入力してください"):r.email="メールアドレスは必須です",e.subject.trim()||(r.subject="件名は必須です"),e.message.trim()?e.message.trim().length<10&&(r.message="メッセージは10文字以上入力してください"):r.message="メッセージは必須です",c(r),Object.keys(r).length===0},re=async r=>{if(r.preventDefault(),!!P()){l(!0);try{await new Promise(u=>setTimeout(u,1e3)),s&&s(e),a({name:"",email:"",subject:"",message:""}),alert("お問い合わせを送信しました！")}catch{alert("送信に失敗しました。もう一度お試しください。")}finally{l(!1)}}},y=r=>{const{name:u,value:me}=r.target;a(f=>({...f,[u]:me})),n[u]&&c(f=>({...f,[u]:void 0}))};return p.jsxs("form",{className:le.form,onSubmit:re,children:[p.jsx(g,{label:"お名前",id:"name",name:"name",value:e.name,onChange:y,type:"text",placeholder:"山田太郎",error:n.name,required:!0}),p.jsx(g,{label:"メールアドレス",id:"email",name:"email",value:e.email,onChange:y,type:"email",placeholder:"example@example.com",error:n.email,required:!0}),p.jsx(g,{label:"件名",id:"subject",name:"subject",value:e.subject,onChange:y,type:"text",placeholder:"お問い合わせの件名",error:n.subject,required:!0}),p.jsx(g,{label:"メッセージ",id:"message",name:"message",value:e.message,onChange:y,type:"textarea",placeholder:"お問い合わせ内容をご記入ください",error:n.message,required:!0,rows:6}),p.jsx(ie,{type:"submit",disabled:o,children:o?"送信中...":"送信する"})]})};oe.__docgenInfo={description:"",methods:[],displayName:"ContactForm",props:{onSubmit:{required:!1,tsType:{name:"signature",type:"function",raw:"(data: ContactFormData) => void",signature:{arguments:[{type:{name:"ContactFormData"},name:"data"}],return:{name:"void"}}},description:""}}};const Be={title:"Components/ContactForm",component:oe,parameters:{layout:"padded",docs:{description:{component:"お問い合わせフォームコンポーネント。名前、メールアドレス、件名、メッセージを入力できます。"}}},argTypes:{onSubmit:{description:"フォーム送信時のコールバック"}}},d={tags:["vrt"],args:{}},v={args:{},play:async({canvasElement:s})=>{const a=m(s).getByRole("button",{name:/送信する/});await t.click(a)}},x={args:{},play:async({canvasElement:s})=>{const e=m(s),a=e.getByPlaceholderText("山田太郎"),n=e.getByPlaceholderText("example@example.com");await t.type(a,"山田太郎"),await t.type(n,"yamada@example.com")}},B={args:{},play:async({canvasElement:s})=>{const e=m(s),a=e.getByPlaceholderText("山田太郎"),n=e.getByPlaceholderText("example@example.com"),c=e.getByPlaceholderText("お問い合わせの件名"),o=e.getByPlaceholderText("お問い合わせ内容をご記入ください");await t.type(a,"山田太郎"),await t.type(n,"yamada@example.com"),await t.type(c,"商品に関するお問い合わせ"),await t.type(o,"こんにちは。商品の在庫状況について教えていただけますでしょうか。よろしくお願いいたします。")}},w={args:{},play:async({canvasElement:s})=>{const e=m(s),a=e.getByPlaceholderText("example@example.com"),n=e.getByPlaceholderText("お問い合わせの件名"),c=e.getByPlaceholderText("お問い合わせ内容をご記入ください"),o=e.getByRole("button",{name:/送信する/});await t.type(a,"yamada@example.com"),await t.type(n,"商品に関するお問い合わせ"),await t.type(c,"こんにちは。商品の在庫状況について教えていただけますでしょうか。"),await t.click(o)}},h={args:{},play:async({canvasElement:s})=>{const e=m(s),a=e.getByPlaceholderText("山田太郎"),n=e.getByPlaceholderText("example@example.com"),c=e.getByPlaceholderText("お問い合わせの件名"),o=e.getByPlaceholderText("お問い合わせ内容をご記入ください"),l=e.getByRole("button",{name:/送信する/});await t.type(a,"山田太郎"),await t.type(n,"invalid-email"),await t.type(c,"商品に関するお問い合わせ"),await t.type(o,"こんにちは。商品の在庫状況について教えていただけますでしょうか。"),await t.click(l)}},b={args:{},play:async({canvasElement:s})=>{const e=m(s),a=e.getByPlaceholderText("山田太郎"),n=e.getByPlaceholderText("example@example.com"),c=e.getByPlaceholderText("お問い合わせの件名"),o=e.getByPlaceholderText("お問い合わせ内容をご記入ください"),l=e.getByRole("button",{name:/送信する/});await t.type(a,"山田太郎"),await t.type(n,"yamada@example.com"),await t.type(c,"商品に関するお問い合わせ"),await t.type(o,"短い"),await t.click(l)}},I={args:{onSubmit:se()},play:async({canvasElement:s,args:e})=>{const a=m(s),n=a.getByPlaceholderText("山田太郎"),c=a.getByPlaceholderText("example@example.com"),o=a.getByPlaceholderText("お問い合わせの件名"),l=a.getByPlaceholderText("お問い合わせ内容をご記入ください"),P=a.getByRole("button",{name:/送信する/});await t.type(n,"山田太郎"),await t.type(c,"yamada@example.com"),await t.type(o,"商品に関するお問い合わせ"),await t.type(l,"こんにちは。商品の在庫状況について教えていただけますでしょうか。よろしくお願いいたします。"),await t.click(P),await ce(()=>{i(e.onSubmit).toHaveBeenCalledWith({name:"山田太郎",email:"yamada@example.com",subject:"商品に関するお問い合わせ",message:"こんにちは。商品の在庫状況について教えていただけますでしょうか。よろしくお願いいたします。"})})}},T={args:{onSubmit:se()},play:async({canvasElement:s,args:e})=>{const a=m(s),n=a.getByRole("button",{name:/送信する/});await t.click(n),await i(e.onSubmit).not.toHaveBeenCalled(),await i(a.getByText("お名前は必須です")).toBeInTheDocument(),await i(a.getByText("メールアドレスは必須です")).toBeInTheDocument(),await i(a.getByText("件名は必須です")).toBeInTheDocument(),await i(a.getByText("メッセージは必須です")).toBeInTheDocument()}},E={args:{},play:async({canvasElement:s})=>{const e=m(s),a=e.getByPlaceholderText("山田太郎"),n=e.getByRole("button",{name:/送信する/});await t.click(n),await i(e.getByText("お名前は必須です")).toBeInTheDocument(),await t.type(a,"山田太郎"),await ce(()=>{i(e.queryByText("お名前は必須です")).not.toBeInTheDocument()})}};var S,F,D;d.parameters={...d.parameters,docs:{...(S=d.parameters)==null?void 0:S.docs,source:{originalSource:`{
  tags: ['vrt'],
  args: {}
